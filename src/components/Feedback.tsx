    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="heading-font text-5xl tracking-tight">What Our Clients Say</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-[#FAF9F6] rounded-3xl p-8">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <div className="font-semibold text-lg">Anjali S.</div>          <div className="text-sm text-gray-500">Bangalore</div>              </div>
            </div>
            ...
            <div className="bg-[#FAF9F6] rounded-3xl p-8">
                <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        <div className="font-semibold text-lg">Rahul M.</div>          <div className="text-sm text-gray-500">Mumbai</div>              </div>
                </div>
            ...
            <div className="bg-[#FAF9F6] rounded-3xl p-8">
                <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        <div className="font-semibold text-lg">Priya K.</div>          <div className="text-sm text-gray-500">Delhi</div>              </div>
                </div>
